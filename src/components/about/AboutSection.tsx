...
export default function AboutSection() {
  ...
  return (
    <section id="about" ref={ref} className="py-16 md:min-h-screen md:py-24 flex items-center justify-center relative z-10">
      ...
      >
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-8 lg:p-16 flex flex-col md:flex-row gap-8 md:gap-12 items-center">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-wrap gap-2 md:gap-3 pt-4">
              {['Full-Stack Development', 'UI/UX Engineering', 'System Architecture', 'AI Integrations'].map(tag => (
                <span key={tag} className="px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-white/5 border border-white/10 text-xs md:text-sm text-gray-300">
                  {tag}
                </span>
              ))}
            </div>
          ...
          <div className="w-48 h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 shrink-0 rounded-2xl overflow-hidden border border-white/10 bg-white/5 relative">
